...
% v_array=[0,100,200,300,400,500,1000,2000,3000]%振荡器线宽,单位Hz
% v_array=[1000,2000,3000,4000,5000]%振荡器线宽,单位Hz
% v_array=2000:2000:8000;
v_array=2000;
% v_array=[1,10]%振荡器线宽,单位Hz
lg_v_array=log10(v_array);
L_v=length(v_array);
Nt=2;%接收天线数
Nr=64;%发射天线数
Nrf=2;%射频链数
...
figure
plot(v_array,mean_array_error_prop4_7_4_db,'r-o','Markersize',8,'Linewidth',1.5)
hold on
plot(v_array,mean_array_error_method5_db,'b-+','Markersize',8,'Linewidth',1.5)
plot(v_array,mean_array_error_method6_db,'k-V','Markersize',8,'Linewidth',1.5)
plot(v_array,mean_LS_error_h_upper_db,'y-V','Markersize',8,'Linewidth',1.5)
plot(v_array,mean_LS_error_h_lower_db,'g-+','Markersize',8,'Linewidth',1.5)
xlabel('Oscillator line width (Hz))');
ylabel('NMSE(dB)');
...
hold off
%% 数据储存dB
data_store1=zeros(L_v,5);%共5条线
data_store1(:,1)=v_array.';
...
temk=kkk-1;
for i=1:L_v
    mean_array_error_prop4_7_4(1,i)=mean(array_error_prop4_7_4(start:temk,i));
    mean_array_error_method5(1,i)=mean(array_error_method5(start:temk,i));%OMP上界
    mean_array_error_method6(1,i)=mean(array_error_method6(start:temk,i));%OMP下界
    mean_LS_error_h_upper(1,i)=mean(LS_error_h_upper(start:temk,i));
    mean_LS_error_h_lower(1,i)=mean(LS_error_h_lower(start:temk,i));
end
mean_array_error_prop4_7_4_db=10*log10(mean_array_error_prop4_7_4);
mean_array_error_method5_db=10*log10(mean_array_error_method5);
mean_array_error_method6_db=10*log10(mean_array_error_method6);
